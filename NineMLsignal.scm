	...
	(sig
	 (append
	  (list
	   ...
	   (Value_sig (ident-create "realparam") 
		      (make-valtype '() (arrow-type label-type (arrow-type sigfun-type sigfun-type))))
	   
	   (Value_sig (ident-create "realsig") 
		      (make-valtype '() (arrow-type label-type (arrow-type sigfun-type sigfun-type))))
	   
	   (Value_sig (ident-create "realfield") 
		      (make-valtype '() (arrow-type label-type (arrow-type sigfun-type sigfun-type))))
	...
	(struct 
	 (append
	  (list 
	   ...
	   (datacon 'sigfun 'realfield 2)
	   (datacon 'sigfun 'realsig 2)
	   (datacon 'sigfun 'realparam 2)
