...
val rk4b: (real vector) stepper1 = make_rk4b()
fun make_stepper (deriv) = rk4b (scaler,summer,deriv)
...
fun RandomUniform(input as {epsilon}) = 
let
val connection = (fn (epsilon) => (if (((op >)(epsilon,random_uniform()))) then 1.0 else 0.0))
val rv316 = (connection (#epsilon(input)))
val rv317 = {connection = rv316}
